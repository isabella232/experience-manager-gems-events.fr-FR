...
user-guide-description: Découvrez AEM Gems, une série de séances approfondies sur des aspects techniques réalisées par des experts d’Adobe Experience Manager.
...
# Événements GEMS Experience Manager {#gems}

+ [Présentation](overview.md)
+ Webinaires à venir{#upcomingwebinars}
   + [annonces](upcomingwebinars/anouncements.md)
+ 2022{#gems2022}
   ...
   + [Adobe Experience Manager as a Cloud Service : Révision 2021 et perspectives 2022](gems2022/aemcloudservice-2021-review-and-outlook.md)
+ 2020{#gems2020}
...
+ 2019{#gems2019}
   + [Nouveautés de Experience Manager 6.5 [!DNL Sites]](gems2019/adobe-experience-manager-6-5-sites-whats-new.md)
...
+ 2018{#gems2018}
   + [Exploration approfondie d’Adobe Experience Manager 6.4](gems2018/aem-6-4-technical-sneak-peek.md)
   + [Adobe Experience Platform - Le coeur de l’Experience Cloud](gems2018/aem-acp.md)
   + [Temps réel et léger : créer des intégrations basées sur des événements avec AEM à l’aide d’événements Adobe I/O](gems2018/aem-adobe-io.md)
   ...
   + [L’explosion et l’utilisation des ressources numériques [!DNL AEM Assets]](gems2018/aem-digital-asset-explosion.md)
   + [Présentation de ContextHub dans AEM 6.4](gems2018/aem-intro-to-contexthub.md)
   + [Apprentissage automatique en AEM : Balises intelligentes améliorées, mise en page intelligente, etc.](gems2018/aem-machine-learning.md)
   + [Maintenir l&#39;open source tout en conservant votre intégrité](gems2018/aem-maintaining-open-source.md)
   + [Résolution des problèmes liés aux requêtes et aux index AEM (suite)](gems2018/aem-query-and-index-troubleshooting2.md)
...
+ 2017{#gems2017}
   + [Mise à jour majeure de Brand Portal et nouvelle implémentation de référence pour Asset Share](/help/gems2017/aem-brand-portal.md)
   + [Créer des contrôles d’intégrité pour AEM](/help/gems2017/aem-building-health-checks-for-aem.md)
   + [Développer des lots et des services OSGi pour AEM](/help/gems2017/aem-developing-osgi-bundles-services-for-aem.md)
   + [Architecture d’AEM Dynamic Media 6.3](/help/gems2017/aem-dynamic-media-architecture.md)
   + [AEM des expériences fluides pour des cas d’utilisation sans interface](/help/gems2017/aem-headless-usecases.md)
   + [Indexation AEM et requête JCR](/help/gems2017/aem-indexing-jcr-query.md)
   + [Intégrations AEM](/help/gems2017/aem-integrations.md)
   + [Gérer AEM DataStore](/help/gems2017/aem-managing-aem-datastore.md)
   + [Formulaires de recherche simplifiés avec AEM Query Builder](/help/gems2017/aem-search-forms-using-querybuilder.md)
   ...
   + [Dans le goudron : une plongée profonde TarMK](/help/gems2017/aem-tarmk-deepdive.md)
   + [Toughday2 - Outil nouveau et amélioré de test de stress et d’évaluation des performances](/help/gems2017/aem-toughday2-stress-testing-benchmarking-tool.md)
   + [AEM 6.3 prête pour le monde - Intégration de traduction et bonnes pratiques](/help/gems2017/aem-translation-best-practices.md)
   + [Résolution des problèmes de réplication AEM](/help/gems2017/aem-troubleshooting-aem-replication.md)
   + [Résolution des problèmes de distribution de contenu sling](/help/gems2017/aem-troubleshooting-sling.md)
+ 2016{#gems2016}
   + [Configuration de la gestion des actifs numériques pour l’entreprise](/help/gems2016/aem-configuring-dam-for-enterprise.md)
   ...
   + [Index Oak Lucene](/help/gems2016/aem-oak-lucene-indexes.md)
   + [Exécutez AEM sur MongoDB](/help/gems2016/aem-running-aem-on-mongodb.md)
   + [Configuration et configuration d’AEM Dynamic Media](/help/gems2016/aem-setup-and-configure-aem-dynamic-media.md)
   + [Présentation technique](/help/gems2016/aem-technical-sneak-peek.md)
...
+ 2015{#gems2015}
   + [Intégration de la traduction AEM 6.1 et bonnes pratiques](/help/gems2015/aem-6-1-translation-integration-and-best-practices.md)
   ...
   + [Exploration approfondie du processus de mise à niveau AEM](/help/gems2015/aem-deep-dive-into-aem-upgrade-process.md)
   + [Mise en cache de Dispatcher - Nouvelles fonctionnalités et optimisations](/help/gems2015/aem-dispatcher-caching-new-features-and-optimizations.md)
   + [AEM [!DNL Forms] Introduction et exemples techniques du pack de fonctionnalités 1](/help/gems2015/aem-forms-feature-pack-1-introduction-and-technical-samples.md)
   + [Intégration d’IBM WebSphere Commerce pour AEM](/help/gems2015/aem-ibm-websphere-commerce-integration-for-aem.md)
   + [Dans ACS AEM Commons et outils](/help/gems2015/aem-inside-acs-aem-commons-and-tools.md)
   + [Module de connexion externe d’Oak](/help/gems2015/aem-oak-external-login-module-authenticating-with-ldap-and-beyond.md)
   + [Sonar : élément clé pour améliorer la qualité du produit](/help/gems2015/aem-sonar-a-key-element-to-improve-product-quality.md)
   + [AEM aperçu technique](/help/gems2015/aem-tech-sneak-peek.md)
   + [Conseils et astuces pour [!DNL AEM Sites] Interface utilisateur tactile](/help/gems2015/aem-tips-and-tricks-for-aem-sites-touch-ui.md)
...
+ 2014{#gems2014}
   + [Déployez Adobe Analytics sur une instance d’AEM locale via le service cloud de la gestion dynamique des balises.](/help/gems2014/aem-adobe-analytics-dynamic-tag-management.md)
   + [Comment tirer le meilleur parti de votre Feature Pack de gestion des actifs numériques](/help/gems2014/aem-dam-feature-pack.md)
   + [Diffusion de contenu géré sur vos applications natives](/help/gems2014/aem-delivering-managed-content-to-your-native-apps.md)
   + [Mode développeur d’AEM 6.0](/help/gems2014/aem-developer-mode.md)
   + [AEM Developer Tools for Eclipse](/help/gems2014/aem-developer-tools-for-eclipse.md)
   + [Dispatcher - Nouvelles fonctionnalités et bonnes pratiques](/help/gems2014/aem-dispatcher.md)
   + [Création efficace de composants réutilisables](/help/gems2014/aem-efficiently-build-reusable-components.md)
   + [Présentation de HTL](/help/gems2014/aem-introduction-to-htl.md)
   + [Traduction automatique dans AEM](/help/gems2014/aem-machine-translation-in-aem.md)
   + [AEM 6 Oak : MongoMK et requêtes](/help/gems2014/aem-oak-mongomk-and-queries.md)
   + [Fonctionnalité du serveur OAuth dans AEM](/help/gems2014/aem-oauth-server-functionality-in-aem.md)
   + [Connecteur SharePoint - Configuration et configuration](/help/gems2014/aem-sharepoint-connector-setup-and-configuration.md)
   + [Structure des composants sociaux dans AEM 6](/help/gems2014/aem-social-component-framework-in-aem-6.md)
   + [Exploration technique approfondie de la plateforme AEM 6](/help/gems2014/aem-technical-deep-dive-into-the-aem-6-platform.md)
   + [Présentation technique de la plateforme AEM 6](/help/gems2014/aem-technical-overview-of-the-aem-6-platform.md)
   + [Personnalisation de l’interface utilisateur pour AEM 6](/help/gems2014/aem-user-interface-customization-for-aem6.md)
+ 2013{#gems2013}
   + [Architecture de la plateforme AEM 5.6](/help/gems2013/aem-architecture-of-the-aem-5-6-platform.md)
   + [Dépannage de CQ/AEM 5.6](/help/gems2013/aem-cq-aem-5-6-troubleshooting.md)
   + [Structure d’intégration eCommerce](/help/gems2013/aem-ecommerce-integration-framework.md)
   + [Intégration de la structure de commerce électronique hybris/AEM 5.6](/help/gems2013/aem-hybris-ecommerce-framework-integration.md)
   + [Introduction de la gestion et du déchargement des tâches dans AEM 5.6.1.](/help/gems2013/aem-job-handling-and-offloading.md)
   + [Lancements : préparation simultanée de plusieurs versions d’un site web (AEM 5.6)](/help/gems2013/aem-launches.md)
   + [AEM 5.6 Présentation approfondie de Media Publisher](/help/gems2013/aem-media-publisher-deep-dive.md)
   + [Gestion des métadonnées dans AEM DAM](/help/gems2013/aem-metadata-management-in-aem-dam.md)
   + [Le développement pour mobile avec CQ simplifié](/help/gems2013/aem-mobile-first-development-with-cq-made-easy.md)
   + [Rationalisation du processus de contenu multilingue](/help/gems2013/aem-streamlining-multilingual-content-process.md)
   + [AEM 5.6 mécanismes de mise à niveau](/help/gems2013/aem-upgrade-mechanisms.md)
